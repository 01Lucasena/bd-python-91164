""" BANCO DE DADOS
    ...
    - EXEMPLO:
        ...
        - ORM: MAPEAMENTO OBJETO RELACIONAL
            - USAR A LINGUAGEM DE PROGAMÇÃO PARA
              MANIPULAR O BANCO DE DADOS.
        - INSTALNDO ORM PARA PYTHON:
...
email_cliente = input("Digite o e-mail que será atualizado: ")

cliente = session.query(Cliente).filter_by(email = email_cliente).first()

if cliente:
    cliente.none = input("Digite seu nome: ")
...
print("\nExcluido os dados de um cliente.")
...
# Read - Select - Consulta
print("Consultado os dados de apenas um cliente")
